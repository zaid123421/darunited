...
import { ServiceProjectsSection } from "@/modules/services/components/service-projects-section";
import type {
  ServiceDetail,
  ServiceMedia,
...
interface ShowServicePageProps {
  service: ServiceDetail;
  mainPic?: ServiceMedia;
  projectsData: ServiceProjectsListData | null;
...
export function ShowServicePage({
  service,
  mainPic,
  projectsData,
  ...
  const resolvedMainPic = mainPic ?? getMainPicFromService(service);
  const galleryItems = getGalleryFromService(service);
    ...
    <div className="flex min-h-full w-full flex-col gap-6 pb-10">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h1 className="page-title mt-4">{service.title}</h1>
          <p className="page-subtitle mt-1">
            Service details and media gallery
          </p>
        </div>
      ...
      <Card className="p-4 sm:p-6">
        ...
        <dl className="flex flex-col gap-5">
          <div className="flex flex-col gap-1.5">
            ...
            <dd className="text-base font-medium text-foreground">{service.title}</dd>
          </div>
        ...
        {resolvedMainPic ? (
          <div className="aspect-video w-full max-w-xl overflow-hidden rounded-xl border border-border bg-muted">
            ...
            <img
              ...
              alt={`${service.title} main thumbnail`}
