...
interface EntityMainPicSectionProps {
...
export function EntityMainPicSection({
  previewUrl,
  onSelectFile,
  onRemove,
  error,
}: EntityMainPicSectionProps) {
    ...
    <Card className="p-4 sm:p-6">
      ...
      <p className="mt-3 text-xs leading-relaxed sm:mt-4 sm:text-sm">
        ...
        <span className="italic text-muted-foreground">
          This image appears as the card thumbnail across the dashboard.
        </span>
      </p>
    </Card>
  );
