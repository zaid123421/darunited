...
export function CategoryProductsSection({
  ...
  // products_page param keeps subcategory page param separate
  const paginationBasePath = `/dashboard/categories/${categoryId}`;
  const paginationPageParam = "products_page";
    ...
    <Card className="p-4 sm:p-6">
      ...
      {loadError ? (
        <p className="text-sm text-destructive">
          Unable to load products for this category. Please refresh and try again.
        </p>
      ) : products.length === 0 ? (
